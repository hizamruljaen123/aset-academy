<div class="p-4 transition-opacity duration-500 opacity-0 fade-in">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 bg-gradient-to-r from-blue-600 to-indigo-700 p-6 rounded-2xl shadow-xl text-white">
        <div class="mb-4 md:mb-0">
            <h1 class="text-3xl font-bold"><?php echo $enrollment->nama_kelas; ?></h1>
        ...
        <div class="flex flex-col md:flex-row md:space-x-3 space-y-3 md:space-y-0">
            ...
            <a href="<?php echo site_url('student/premium'); ?>" class="inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400 transition-all duration-300 hover:scale-105">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="font-medium"><?php echo $mentor_name ?? 'Mentor'; ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="font-medium"><?php echo $enrollment->durasi; ?> jam</p>
                            </div>
                        </div>
        ...
        <div class="lg:col-span-3">
            ...
            <div class="bg-white rounded-2xl shadow-xl ring-1 ring-gray-200/50 overflow-hidden mb-8 fade-in">
                <div class="p-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Selamat Datang di Kelas Premium</h2>
                    <div class="prose max-w-none text-gray-600">
                        <?php echo $enrollment->deskripsi; ?>
                    </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium
                                    ...
                                    elseif ($enrollment->status == 'Active') echo 'bg-blue-100 text-blue-800';
                                    else echo 'bg-red-100 text-red-800';
                                    ?>">
                                    <?php
                                    if ($enrollment->status == 'Completed') echo 'Selesai';
                                    elseif ($enrollment->status == 'Active') echo 'Sedang Berjalan';
                                    else echo 'Keluar';
                                    ?>
                                </p>
                            </div>
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <?php elseif ($attendance && $attendance['can_attend']): ?>
                                                <!-- Can attend now -->
                                                <button onclick="submitAttendance(<?php echo $j->id; ?>, <?php echo $enrollment->id; ?>)" class="inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-300">
                            ...
                            <?php foreach ($materials as $index => $material): ?>
                                ...
                                <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                                    ...
                                    <div class="p-4 bg-white">
                                        <p class="text-sm text-gray-600 mb-2"><?php echo substr(strip_tags($material->deskripsi), 0, 100) . '...'; ?></p>
                            ...
                            <?php foreach ($discussions as $discussion): ?>
                                <?php if ($discussion->parent_id === null): ?>
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        ...
                                        <div class="border-t border-gray-200">
                                            <div class="p-4 pl-12">
                                                <form action="<?php echo site_url('student/premium/post_discussion'); ?>" method="post">
...
<script>
    ...
    function submitAttendance(jadwalId, enrollmentId) {
        ...
        fetch('<?php echo site_url("student/premium/submit_attendance"); ?>', {
            method: 'POST',
            headers: {
