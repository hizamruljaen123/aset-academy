...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Edit Kategori Kelas</h1>
                <p class="text-gray-600">Perbarui informasi kategori kelas</p>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="class_type"
                        ...
                        <option value="premium" <?php echo set_select('class_type', 'premium', ($category->class_type == 'premium')); ?>>
                            Premium (Kelas Programming)
                        </option>
                        <option value="free" <?php echo set_select('class_type', 'free', ($category->class_type == 'free')); ?>>
                            Gratis (Free Classes)
                        </option>
                    </select>
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox"
                               ...
                               name="is_active"
                               value="1"
                               <?php echo set_checkbox('is_active', '1', ($category->is_active == 1)); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description"
                              ...
                              placeholder="Jelaskan kategori ini lebih detail..."><?php echo set_value('description', $category->description); ?></textarea>
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-gray-600">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <span class="font-medium">Slug:</span> <?php echo htmlspecialchars($category->slug); ?>
                        </div>
                        <div>
                            <span class="font-medium">Dibuat:</span> <?php echo date('d M Y H:i', strtotime($category->created_at)); ?>
                        </div>
                        <div>
                            <span class="font-medium">Diperbarui:</span> <?php echo date('d M Y H:i', strtotime($category->updated_at)); ?>
                        </div>
                    </div>
                </div>
            </div>
