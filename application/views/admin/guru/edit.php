<div class="p-4 transition-opacity duration-500 opacity-0">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 bg-white p-6 rounded-lg shadow">
        <div class="mb-4 md:mb-0">
            ...
            <p class="text-gray-600 mt-1">Perbarui data untuk <?php echo $teacher->nama_lengkap; ?></p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900">Formulir Edit Guru</h2>
        </div>
        <div class="p-6">
            <?php echo form_open('admin_guru/edit/'.$teacher->id, 'class="space-y-6"'); ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nama_lengkap" name="nama_lengkap" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" 
                               value="<?php echo set_value('nama_lengkap', $teacher->nama_lengkap); ?>" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="email" id="email" name="email" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" 
                               value="<?php echo set_value('email', $teacher->email); ?>" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="username" name="username" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" 
                               value="<?php echo set_value('username', $teacher->username); ?>" required>
                        <?php echo form_error('username', '<p class="mt-1 text-sm text-red-600">', '</p>'); ?>
                    </div>
                    <div class="space-y-2">
                        <label for="status" class="block text-sm font-medium text-gray-700">Status <span class="text-red-500">*</span></label>
                        <select id="status" name="status" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                            <option value="Aktif" <?php echo set_select('status', 'Aktif', ($teacher->status == 'Aktif')); ?>>Aktif</option>
                            <option value="Tidak Aktif" <?php echo set_select('status', 'Tidak Aktif', ($teacher->status == 'Tidak Aktif')); ?>>Tidak Aktif</option>
                        </select>
                ...
                <div class="space-y-2">
                    ...
                    <input type="password" id="password" name="password" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
