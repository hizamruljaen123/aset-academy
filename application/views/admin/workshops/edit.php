                ...
                <?= form_open_multipart('admin/workshops/edit/'.encrypt_url($workshop->id), ['class' => 'space-y-6']) ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="8" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"><?= set_value('description', $workshop->description) ?></textarea>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div class="relative">
                                <div id="poster-upload-area" class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 transition-colors duration-300 cursor-pointer bg-gray-50 hover:bg-blue-50">
                                    ...
                                    <div id="upload-placeholder" class="<?= $workshop->thumbnail ? 'hidden' : '' ?>">
                                        <div class="mb-4">
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                let hasExistingPoster = <?= $workshop->thumbnail ? 'true' : 'false' ?>;
                                ...
                                removePosterBtn.addEventListener('click', function() {
                                    resetPosterUpload();
                                    // Add a hidden input to indicate poster should be removed
                                    let removeInput = document.createElement('input');
                                    removeInput.type = 'hidden';
                                    removeInput.name = 'remove_poster';
                                    removeInput.value = '1';
                                ...
                                function resetPosterUpload() {
                                    ...
                                    // Remove any existing remove_poster input
                                    const removeInput = document.querySelector('input[name="remove_poster"]');
                                    if (removeInput) {
                                        removeInput.remove();
                                    }
                                }
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <option value="coming soon" <?= $workshop->status == 'coming soon' ? 'selected' : '' ?>>Coming Soon</option>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Coming Soon: Workshop sudah dibuat dan muncul di website namun masih menunggu persiapan</p>
                        </div>
                    </div>
