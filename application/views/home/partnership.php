        ...
        <div class="relative container mx-auto px-4 z-10">
            <div class="text-center mb-16" data-aos="fade-up">
                <div class="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-100 to-orange-100 px-4 py-2 rounded-full mb-4">
                    ...
                    <span class="text-sm font-semibold text-yellow-700">Harga Disuaikan</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-6">Harga Sesuai Kebutuhan Anda</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                    <strong class="text-indigo-600">Tidak ada paket harga fixed.</strong> Setiap program pelatihan dirancang khusus sesuai kebutuhan perusahaan Anda.
                    Harga ditentukan berdasarkan jumlah peserta, durasi, kompleksitas materi, dan mode pelatihan (online/offline).
                </p>
            </div>

            <div class="max-w-4xl mx-auto">
                <!-- Pricing Calculator Card -->
                <div class="bg-gradient-to-br from-white to-indigo-50 rounded-3xl p-8 md:p-12 shadow-2xl border border-indigo-100 relative overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                    <!-- Background pattern -->
                    <div class="absolute inset-0 opacity-5">
                    ...
                    <div class="relative z-10">
                        <div class="text-center mb-8">
                            <div class="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                                <i data-feather="calculator" class="w-10 h-10 text-white"></i>
                            </div>
                            <h3 class="text-3xl font-bold text-gray-800 mb-4">Kalkulator Harga Indikatif</h3>
                            <p class="text-lg text-gray-600">Estimasi harga berdasarkan parameter umum</p>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <!-- Participant Count -->
                            <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-6 text-center">
                                ...
                                <h4 class="font-bold text-gray-800 mb-2">Jumlah Peserta</h4>
                                <div class="text-2xl font-bold text-blue-600">5-50 orang</div>
                                <p class="text-sm text-gray-600 mt-2">Diskon volume mulai 10 peserta</p>
                            </div>
                            ...
                            <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-6 text-center">
                                ...
                                <h4 class="font-bold text-gray-800 mb-2">Durasi</h4>
                                <div class="text-2xl font-bold text-green-600">2-12 minggu</div>
                                <p class="text-sm text-gray-600 mt-2">Intensif atau bertahap</p>
                            </div>
                            ...
                            <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-6 text-center">
                                ...
                                <h4 class="font-bold text-gray-800 mb-2">Mode Pelatihan</h4>
                                <div class="text-2xl font-bold text-purple-600">Online/Offline</div>
                                <p class="text-sm text-gray-600 mt-2">Pilih sesuai kebutuhan</p>
                            </div>
                        </div>

                        <!-- Price Range -->
                        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-white text-center">
                            <h4 class="text-2xl font-bold mb-4">Range Harga per Orang</h4>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                    <div class="text-lg font-semibold">Online Basic</div>
                                    <div class="text-3xl font-bold">Rp 500rb</div>
                                    <div class="text-sm opacity-90">per hari</div>
                                </div>
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                    <div class="text-lg font-semibold">Online Advanced</div>
                                    <div class="text-3xl font-bold">Rp 750rb</div>
                                    <div class="text-sm opacity-90">per hari</div>
                                </div>
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                    <div class="text-lg font-semibold">Offline Basic</div>
                                    <div class="text-3xl font-bold">Rp 750rb</div>
                                    <div class="text-sm opacity-90">per hari</div>
                                </div>
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                    <div class="text-lg font-semibold">Offline Advanced</div>
                                    <div class="text-3xl font-bold">Rp 1jt</div>
                                    <div class="text-sm opacity-90">per hari</div>
                                </div>
                            </div>
                            <p class="text-sm opacity-80 mt-4">*Harga final disesuaikan setelah konsultasi mendalam</p>
                        </div>

                        <!-- WhatsApp CTA -->
                        <div class="text-center mt-8">
                            <p class="text-gray-600 mb-6">Dapatkan penawaran harga yang sesuai kebutuhan perusahaan Anda</p>
                            <a href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20konsultasi%20harga%20program%20partnership%20untuk%20tim%20kami"
                               class="group inline-flex items-center gap-3 bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-green-600 hover:to-green-700 hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl">
                                <i data-feather="message-circle" class="w-6 h-6 group-hover:scale-110 transition-transform"></i>
