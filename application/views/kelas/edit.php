...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg p-6 mb-8 text-white">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-bold">Edit Kelas Programming</h1>
                <p class="text-blue-100 mt-1">Perbarui detail kelas programming untuk memperbaharui koleksi kursus</p>
            </div>
        </div>
    </div>
        ...
        <div class="px-8 py-6">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nama_kelas" name="nama_kelas"
                               ...
                               value="<?php echo set_value('nama_kelas', $kelas->nama_kelas); ?>"
                        ...
                        <select id="category_id" name="category_id"
                            ...
                            <?php if (!empty($categories)): ?>
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?php echo $category->id; ?>" <?php echo set_select('category_id', $category->id, isset($kelas->category_id) && $kelas->category_id == $category->id); ?>>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="bahasa_program" name="bahasa_program"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
                               value="<?php echo set_value('bahasa_program', $kelas->bahasa_program); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <textarea id="deskripsi" name="deskripsi" style="display: none;" required><?php echo set_value('deskripsi', $kelas->deskripsi); ?></textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select id="status" name="status"
                            ...
                            <option value="Coming Soon" <?php echo set_select('status', 'Coming Soon', $kelas->status == 'Coming Soon'); ?>>Coming Soon</option>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" id="durasi" name="durasi" min="1"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
                               value="<?php echo set_value('durasi', $kelas->durasi); ?>"
                               required>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="harga" name="harga" min="0"
                                   ...
                                   value="<?php echo set_value('harga', $kelas->harga); ?>"
                                   required>
                        </div>
            ...
            <div class="space-y-6 pt-8 border-t border-gray-200">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800">Pembelajaran Online</h2>
                </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" id="online_meet_link" name="online_meet_link"
                                   class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
                                   value="<?php echo set_value('online_meet_link', $kelas->online_meet_link); ?>"
...
<?php elseif ($kelas->deskripsi): ?>
    quill.root.innerHTML = <?= json_encode($kelas->deskripsi) ?>;
<?php endif; ?>
