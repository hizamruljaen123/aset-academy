    ...
    <div class="max-w-1xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <a href="<?php echo site_url('forum/create_thread/' . $category->slug); ?>" 
        ...
        <div class="space-y-4">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-12 bg-white rounded-lg shadow">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo site_url('forum/create_thread/' . $category->slug); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            <i class="fas fa-plus mr-2"></i>
                            Buat Topik Baru
                        </a>
                    </div>
