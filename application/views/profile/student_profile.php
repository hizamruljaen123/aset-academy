    ...
    <?php if (isset($profile_exists) && !$profile_exists): ?>
        <div class="mb-6 p-4 rounded-lg bg-yellow-50 border-l-4 border-yellow-500 flex items-center fade-in">
            ...
            <div class="flex-1 text-yellow-700">
                ...
                <p>Data siswa Anda belum terdaftar dalam sistem. Silakan lengkapi profil Anda.</p>
            </div>
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        <div class="h-24 w-24 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-3xl shadow-lg">
                            <?php echo !empty($profile->nama_lengkap) ? strtoupper(substr($profile->nama_lengkap, 0, 1)) : strtoupper(substr($user->nama_lengkap, 0, 1)); ?>
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                        <div class="flex items-center bg-gray-50 rounded-lg p-4 transition-all duration-300 hover:bg-gray-100">
                            ...
                            <div>
                                ...
                                <p class="font-medium"><?php echo isset($profile->nis) ? $profile->nis : 'Belum terdaftar'; ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center bg-gray-50 rounded-lg p-4 transition-all duration-300 hover:bg-gray-100">
                            ...
                            <div>
                                ...
                                <p class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium <?php echo (isset($profile->status) && $profile->status == 'Aktif') ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'; ?>">
                                    <?php echo isset($profile->status) ? $profile->status : 'Belum terdaftar'; ?>
                                </p>
                            </div>
                        </div>
                        
                        <?php if (isset($profile->no_telepon)): ?>
                        <div class="flex items-center bg-gray-50 rounded-lg p-4 transition-all duration-300 hover:bg-gray-100">
                            <div class="rounded-full bg-blue-100 p-2 mr-3">
                            ...
                            <div>
                                ...
                                <p class="font-medium"><?php echo $profile->no_telepon; ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if (isset($profile->tanggal_lahir)): ?>
                        <div class="flex items-center bg-gray-50 rounded-lg p-4 transition-all duration-300 hover:bg-gray-100">
                            <div class="rounded-full bg-indigo-100 p-2 mr-3">
                            ...
                            <div>
                                ...
                                <p class="font-medium"><?php echo date('d F Y', strtotime($profile->tanggal_lahir)); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center bg-gray-50 rounded-lg p-4 transition-all duration-300 hover:bg-gray-100">
                            <div class="rounded-full bg-purple-100 p-2 mr-3">
                                <i class="fas fa-<?php echo $profile->jenis_kelamin == 'L' ? 'male' : 'female'; ?> text-purple-600"></i>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Jenis Kelamin</p>
                                <p class="font-medium"><?php echo $profile->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'; ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if (isset($profile->alamat)): ?>
                        <div class="sm:col-span-2 flex items-center bg-gray-50 rounded-lg p-4 transition-all duration-300 hover:bg-gray-100">
                            <div class="rounded-full bg-green-100 p-2 mr-3">
                                <i class="fas fa-map-marker-alt text-green-600"></i>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Alamat</p>
                                <p class="font-medium"><?php echo $profile->alamat; ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
